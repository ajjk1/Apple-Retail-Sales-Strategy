...
export default function InvestorDashboardPage() {
  ...
  // 재고 가치 막대 그래프: frozen_money + inventory 대비 비중 (상위 N개, 제품 또는 매장·제품)
  ...
  // 상태 알림: Status가 Normal(정상)이면서 inventory < safety_stock 인 항목
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f7] text-[#1d1d1f]">
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="p-2 rounded-lg hover:bg-gray-100 text-[#6e6e73] hover:text-[#1d1d1f]" aria-label="메인으로">
              ←
            </Link>
            <div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* 요약 위젯: 총 동결 자금 합계 + 엔진 도입 시 예상 추가 이익 */}
        ...
        {/* 재고 가치 시각화: frozen_money 막대 + inventory 대비 비중 */}
        ...
        {/* 상태 알림: Status Normal 이면서 inventory < safety_stock → 빨간 경고 */}
        <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-8">
